...
.. list-table::
   ...
   * - Electronic Attestation of Identity
     - Electronic attestation of attributes referring to master data already present in digital identity systems.
   * - Digital Credential
   ...
   * - Trust Layer
     - An architectural component that enables Wallet system participants to establish trust, in terms of reliability and compliance of all participants with the regulatory framework governing the digital identity system.
   * - Trust Model
